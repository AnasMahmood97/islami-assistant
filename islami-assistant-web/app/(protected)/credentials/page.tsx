...
export default function CredentialsPage() {
  ...
  return (
    <section className="chat-pane">
      ...
      <div className="rounded-2xl border border-dashed border-[#9e1b1f]/30 p-3">
        <p className="mb-2 text-sm font-semibold text-slate-700">نموذج إضافة يوزر جديد</p>
        <div className="grid gap-2 md:grid-cols-3">
          <input className="input" placeholder="اسم الموظف" value={form.system} onChange={(e) => setForm((s) => ({ ...s, system: e.target.value }))} />
      ...
      <div className="mt-4">
        <p className="mb-2 text-sm font-semibold text-slate-700">قائمة البطاقات الحالية</p>
